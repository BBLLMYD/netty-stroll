package com.skr.signal.common.registey.impl;

import com.skr.signal.common.rpc.client.RpcClientHandler;
import com.skr.signal.common.rpc.client.RpcClientInitializer;
...
/**
 * @author mqw
 * @create 2020-06-22-13:43
 */
public class ZKConnectManage {
    private static final Logger logger = LoggerFactory.getLogger(ZKConnectManage.class);
    private volatile static ZKConnectManage connectManage;
    ...
    private ZKConnectManage() {
    }

    public static ZKConnectManage getInstance() {
        if (connectManage == null) {
            synchronized (ZKConnectManage.class) {
                if (connectManage == null) {
                    connectManage = new ZKConnectManage();
                }
            }
        }
